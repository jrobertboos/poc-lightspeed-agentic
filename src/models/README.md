...
| `AgentRunResponse` | `POST /agents/run` | Agent output, tool calls, tool results, and success status |
...
| `WorkflowRunResponse` | `POST /workflows/run` | Workflow output, history, and success status |
